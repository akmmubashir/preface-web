...
export async function getPostsDefault() {
  return [
    ...
    },
    {
      ...
      excerpt:
        "Exploring the potential impact of artificial intelligence on our daily lives and future society.",
    ...
    },
    {
      ...
      excerpt:
        "Discover the latest fitness innovations and workout trends that are reshaping the fitness industry.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to cryptocurrency trends, blockchain technology, and digital finance.",
...
export async function getPostsAudio() {
  return [
    ...
    },
    {
      ...
      excerpt:
        "Experience the full majesty of Beethoven's Ninth Symphony in this complete performance.",
      date: "2025-05-15T12:00:00Z",
      readingTime: 3,
      commentCount: 45,
      viewCount: 3200,
    ...
    },
    {
      ...
      excerpt:
        "A special tribute to Miles Davis featuring contemporary jazz artists.",
      date: "2025-04-20T12:00:00Z",
      readingTime: 2,
      commentCount: 34,
      viewCount: 2800,
    ...
    },
    {
      ...
      excerpt:
        "The most memorable sets from Tomorrowland 2025, featuring top electronic music artists.",
      date: "2025-03-05T12:00:00Z",
      readingTime: 4,
      commentCount: 89,
      viewCount: 4500,
    ...
    },
    {
      ...
      excerpt:
        "Experience the electrifying performance of legendary rock bands at the iconic venue.",
      date: "2025-02-15T12:00:00Z",
      readingTime: 3,
      commentCount: 56,
      viewCount: 3800,
    ...
    },
    {
      ...
      excerpt:
        "An exclusive look into the art of hip hop production with industry experts.",
      date: "2025-01-20T12:00:00Z",
      readingTime: 4,
      commentCount: 78,
      viewCount: 4200,
    ...
    },
    {
      ...
      excerpt:
        "A celebration of diverse musical traditions from around the world.",
    ...
    },
    {
      ...
      excerpt:
        "A mesmerizing collection of Chopin's most beautiful nocturnes performed by world-renowned pianists.",
    ...
    },
    {
      ...
      excerpt:
        "An insightful discussion about emerging technologies and their impact on our digital future.",
    ...
    },
    {
      ...
      excerpt:
        "A curated collection of calming meditation sessions for stress relief and mindfulness.",
    ...
    },
    {
      ...
      excerpt:
        "An in-depth conversation about artificial intelligence, its current state, and future implications.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to incorporating mindfulness and meditation into your daily routine.",
...
export async function getPostsVideo() {
  return [
    ...
    },
    {
      ...
      excerpt:
        "An in-depth look at the challenges and possibilities of human exploration of Mars.",
      date: "2025-05-15",
      readingTime: 5,
      commentCount: 67,
      viewCount: 4200,
    ...
    },
    {
      ...
      excerpt:
        "Learn the art of French cooking with step-by-step tutorials from a master chef.",
      date: "2025-03-05",
      readingTime: 4,
      commentCount: 78,
      viewCount: 5200,
    ...
    },
    {
      ...
      excerpt:
        "An extraordinary journey into the heart of the world's most diverse ecosystems.",
      date: "2025-02-15",
      readingTime: 6,
      commentCount: 89,
      viewCount: 4800,
    ...
    },
    {
      ...
      excerpt:
        "Exploring the latest developments in artificial intelligence and their implications.",
      date: "2025-01-20",
      readingTime: 4,
      commentCount: 67,
      viewCount: 4500,
    ...
    },
    {
      ...
      excerpt:
        "Discover the lesser-known treasures of Asia's most fascinating locations.",
      date: "2025-01-05",
      readingTime: 5,
      commentCount: 92,
      viewCount: 5100,
    ...
    },
    {
      ...
      excerpt:
        "An extraordinary journey into the depths of our oceans, revealing its hidden wonders.",
      date: "2024-12-20",
      readingTime: 5,
      commentCount: 78,
      viewCount: 4500,
    ...
    },
    {
      ...
      excerpt:
        "An inspiring look at the dedication and training behind Olympic success stories.",
      date: "2024-12-15",
      readingTime: 4,
      commentCount: 92,
      viewCount: 5100,
    ...
    },
    {
      ...
      excerpt:
        "Uncovering the mysteries of ancient civilizations through archaeological discoveries.",
      date: "2024-12-10",
      readingTime: 6,
      commentCount: 85,
      viewCount: 4800,
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive look at how education has evolved and where it's heading in the digital age.",
      date: "2024-12-05",
      readingTime: 5,
      commentCount: 82,
      viewCount: 4700,
...
export async function getPostsGallery() {
  return [
    ...
    },
    {
      ...
      excerpt:
        "A stunning collection of mountain landscapes captured across different seasons and times of day.",
      date: "2024-12-20",
      readingTime: 4,
      commentCount: 72,
      viewCount: 4600,
    ...
    },
    {
      ...
      excerpt:
        "Captivating moments of wildlife in their natural habitats, showcasing the beauty of nature.",
      date: "2024-12-15",
      readingTime: 5,
      commentCount: 85,
      viewCount: 4900,
    ...
    },
    {
      ...
      excerpt:
        "A visual exploration of contemporary architecture and urban design from around the world.",
      date: "2024-12-10",
      readingTime: 3,
      commentCount: 63,
      viewCount: 4300,
...
export async function getPostByHandle(handle: string) {
  ...
  if (
    !handle ||
    handle.includes(".") ||
    handle.includes("com.chrome.devtools.json")
  ) {
