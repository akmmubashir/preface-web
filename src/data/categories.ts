  ...
  return [
    {
      ...
      handle: "technology",
      description:
        "Explore the latest innovations, gadgets, and tech trends shaping our digital future.",
      count: 10,
    },
    {
      id: "tag-2",
      ...
      handle: "travel",
      description:
        "Explore travel guides, destination reviews, and adventure stories from around the world.",
      count: 10,
    },
    {
      id: "tag-3",
      ...
      handle: "food",
      description:
        "Discover the best food and drink experiences, from local cuisine to gourmet dining.",
      count: 10,
    },
    {
      id: "tag-4",
      ...
      handle: "health",
      description:
        "Stay updated with health and wellness news, tips, and expert advice.",
      count: 10,
    },
    {
      id: "tag-5",
      ...
      handle: "science",
      description:
        "Explore the latest scientific discoveries, research, and breakthroughs.",
      count: 10,
    },
    {
      id: "tag-6",
      ...
      handle: "history",
      description:
        "Discover historical events, cultural heritage, and the stories of our past.",
      count: 10,
    },
    {
      id: "tag-7",
      ...
      handle: "art",
      description:
        "Explore the world of art, from painting to sculpture and everything in between.",
      count: 10,
    },
    {
      id: "tag-8",
      ...
      handle: "photography",
      description:
        "Discover the art of photography, from landscape shots to portrait techniques and editing tips.",
      count: 15,
    },
    {
      id: "tag-9",
      ...
      handle: "music",
      description:
        "Explore music reviews, artist interviews, and the latest trends in the music industry.",
      count: 12,
    },
    {
      id: "tag-10",
    ...
    },
    {
      ...
      handle: "education",
      description:
        "Stay informed about educational trends, learning resources, and academic insights.",
      count: 11,
    },
  ];
}
