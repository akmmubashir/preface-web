        ...
        <div className="relative flex flex-col items-start gap-6 rounded-3xl border border-transparent bg-white p-5 shadow-xl md:flex-row md:rounded-4xl lg:p-8 dark:border-neutral-700 dark:bg-neutral-900">
          ...
          <div className="grow lg:ps-2">
            <div className="max-w-(--breakpoint-sm) space-y-3.5">
              ...
              <Link
                href="#"
                className="flex items-center gap-x-2 text-xs text-neutral-500 dark:text-neutral-400"
              >
  ...
  return (
    <>
      ...
      >
        <DialogTitle>
          Hide this author?{" "}
          <span className="font-semibold">({author.name.trim()})</span>
        </DialogTitle>
        <DialogBody>
          <p>
            Are you sure you want to hide the{" "}
            <span className="font-semibold">{author.name.trim()}</span>? This
            action will hide all posts from this author.
          </p>
        </DialogBody>
        <DialogActions>
