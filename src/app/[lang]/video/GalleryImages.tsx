  ...
  return (
    <div className="relative size-full embla">
      ...
      >
        <div className="embla__container size-full">
          {images.map((image, index) => (
            <div
              className="relative z-50 flex embla__slide basis-full items-center justify-center"
              key={index}
            >
              <Image
                alt="Slide image"
      ...
      <div className="embla-thumbs fixed inset-x-0 bottom-5 z-10">
        <div
          className="embla-thumbs__viewport mx-auto max-w-28"
          ref={emblaThumbsRef}
        >
      ...
      >
        ...
        <div className="fixed inset-0 flex w-screen items-center justify-center">
          ...
          >
            <EmblaCarousel
              images={images}
              option={{ startIndex, slidesToScroll: 1 }}
            />
          </DialogPanel>
        </div>
      </Dialog>
