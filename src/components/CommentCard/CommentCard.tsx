...
const CommentCard: FC<Props> = ({ className, comment }) => {
  ...
  const [isOpenDialogReportComment, setIsOpenDialogReportComment] =
    useState(false);
  ...
  return (
    <>
      ...
      <Dialog
        open={isOpenDialogReportComment}
        onClose={() => setIsOpenDialogReportComment(false)}
      >
        <DialogTitle>Report this comment?</DialogTitle>
        <DialogBody>
          <p>
            Are you sure you want to report this comment? This action will
            report this comment.
          </p>
        </DialogBody>
        <DialogActions>
          ...
          <Button onClick={() => setIsOpenDialogReportComment(false)}>
            Report
          </Button>
        </DialogActions>
      </Dialog>
