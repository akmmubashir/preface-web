      ...
      <div
        ...
        className={clsx(
          ...
          isFocusVisible || state.isThumbDragging(index)
            ? "w-1.5 bg-slate-900 dark:bg-slate-100"
            : "w-1 bg-slate-700 dark:bg-slate-300"
        )}
      >
        <VisuallyHidden>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        ref={trackRef}
        className="relative w-full bg-slate-100 md:rounded-full dark:bg-neutral-800"
      >
        <div
          className={clsx(
      ...
      <div className="hidden items-center gap-2 md:flex">
        <output
          ...
          className={clsx(
            ...
            isFocusVisible || state.isThumbDragging(0)
              ? "bg-slate-100 text-slate-900 dark:bg-neutral-800 dark:text-slate-100"
        ...
        <span
          className={clsx(
            "hidden rounded-md px-1 py-0.5 font-mono text-sm leading-6 text-slate-500 md:block dark:text-slate-400",
            state.getThumbMaxValue(0) === 0 && "opacity-0"
          )}
        >
