...
const Card18: FC<Props> = ({
  ...
  return (
    <div
      className={clsx(
        "group post-card-18 relative flex flex-col overflow-hidden rounded-xl",
        className
      )}
    >
      ...
      <div className="absolute inset-x-0 bottom-0 flex grow flex-col p-6">
        ...
        <div className="flex flex-col items-center gap-2">
          <p
            className={clsx(
              "mt-3 line-clamp-2 text-[12px] leading-snug font-medium text-white sm:text-sm"
            )}
          >
            {excerpt}
          </p>
