...
const Card2: FC<Props> = ({ className, size = "normal", post }) => {
  ...
  return (
    <div
      className={clsx("group post-card-2 relative flex flex-col", className)}
    >
      ...
      <div className="mt-5 flex flex-col sm:px-4">
        <div className="space-y-3">
          ...
          <p className="block text-sm/6 text-neutral-600 dark:text-neutral-400">
            {excerpt}
          </p>
        </div>
