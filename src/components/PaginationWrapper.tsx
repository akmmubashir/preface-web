...
function PaginationComponent({ totalPages = 10, className }: Props) {
  ...
  return (
    <Pagination className={className}>
      ...
      />
      <PaginationList>
        <PaginationPage href={pathname + "?" + createQueryString("page", "1")}>
          1
        </PaginationPage>
        <PaginationPage
          current
        ...
        <PaginationPage href={pathname + "?" + createQueryString("page", "3")}>
          3
        </PaginationPage>
        <PaginationGap />
        <PaginationPage href={pathname + "?" + createQueryString("page", "15")}>
          15
        </PaginationPage>
        <PaginationPage href={pathname + "?" + createQueryString("page", "16")}>
          16
        </PaginationPage>
      </PaginationList>
      <PaginationNext
